...
blockTwoHandler.addEventListener("click", function(){ insertOverlay('Le jardin experimental du CATPC', 'Inventaire du jardin expérimental du CAPTC financé grâce aux fonds issus de ventes d’oeuvres d’art<br /> <br /> Cacao:<br /> 6650 plants en bon état<br /> <br /> Huile de palme:<br /> 801 plants en bon état<br /> Surface couverte, avec 30 pieds de distance entre chaque plant: 17 acres<br /> <br /> Arbres fruitiers (mélange de différentes espèces comprenant avocatiers, mandariniers, ananas, bananiers):<br /> Surface couverte, avec 32 pieds de distance entre chaque plant: 15 acres<br /> <br /> Matériel en stock:<br /> 12 machettes, 2 brouettes, 10 binettes, 10 bêches, 3 râteaux, 5 arrosoirs, 7500 sacs de cacao, 800 sachets de palme, 2 carnets de note, 5 stylos et 1 latte.<br /> <br /> Agenda:<br /> Février et mi-mars 2017: Plantation des bananiers<br /> Mars 2017: Plantation des plants de cacao sous les bananiers<br /> Septembre 2017: Plantation des palmiers à huile<br /> Mai 2017: Plantation des légumes<br />', 'garden') }, false);
...
blockFourHandler.addEventListener("click", function(){ insertOverlay('PLATE-FORME EN LIGNE', 'Une connection wi-fi installée dans le musée White Cube signé par l’OMA transformera la plantation au coeur de la forêt congolaise en un centre dédié à l’innovation et à la connaissance.<br/><br/>La plate-forme connectera la recherche du LIRCAEI aux autres plantations et musées du globe. Connectée aux réseaux internationaux le White Cube transformera l’ancienne plantation d’huile de palme de Lusanga en un outil de légitimation, d’investigation, ainsi qu’en un relai de stratégies de résistance et de visions globales pour l’avenir des travailleurs de la plantation.<br/><br/>En quelques clics, les travailleurs de la plantation et les esprits créatifs du monde entier auront accès au catalogue d’outils et aux ressources rassemblés par des curateurs éminents invités à participer aux discussions en ligne. Le contenu du programme trimestriel sera rendu disponible en anglais, en français et en lingala.<br/><br/>La plate-forme, actuellement en construction, devrait être active en octobre 2017. Le développement et la production de la plate-forme seront supervisés par Pieter van Huystee Film & TV.', 'platform') }, false);
blockTenHandler.addEventListener("click", function(){ insertOverlay('Localisation', 'Le site sur lequel est implanté le centre de recherche est d’une importance capitale: le LIRCAEI est construit à Lusanga-même, ancienne “Leverville” où la société des Frères Levers (renommée par la suite Unilever) fonda sa toute première plantation d\'huile de palme en 1911.<br /><br />En termes économiques, les plantations furent non seulement à la base de la construction de la plupart des infrastructures et industries européennes et américaines mais aussi au départ de musées et d’universités. D’un point de vue idéologique, la violence et la brutalité déployées d’un côté - dans les zones de plantation - ont façonné et hanté la prétendue civilité, le goût et l’esthétique revendiqués de l’autre côté: les White Cubes.<br /><br />En confrontant ces deux pôles opposés de chaînes de valeur globales, le LIRCAEI vise à surmonter tant la monoculture du système de plantation, qui épuise les personnes et l’environnement, que la stérilité du White Cube - ce havre de paix où la critique, l’amour, la singularité sont libres mais qui bien souvent réaffirme les divisions entre classes sociales.<br /><br />Ce n’est que là, au coeur du système de plantation, au carrefour des inégalités globales et du changement climatique, que nous pourrons redéfinir le mandat de l’art.<br/>', 'location') }, false);
